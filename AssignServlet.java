...
//            request.setAttribute("assigns", filteredProducts);
//        }
        int categoryId = request.getParameter("categoryId") == null ? 0
                : Integer.valueOf(request.getParameter("categoryId"));
        ...
        try {
            if (categoryId == 0) {
                em.find(Productlist.class, categoryId);
                request.setAttribute("assigns", list);
            } else {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (productId == 0) {
            ...
            Productlist product = em.find(Productlist.class, productId);
        ...
        response.sendRedirect("/ProductManagerment/category-servlet");
    }
